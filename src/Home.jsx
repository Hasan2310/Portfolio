...
function App() {
  ...
  return (
    ...
    <section className="section h-screen">
      <div className="text-[#e9e9ea] flex flex-col items-center justify-center h-screen">
        {/* Animasi Gambar */}
        <img
          src={gambar} // Pastikan gambar sudah ada di path yang benar
          className="md:w-2xl w-3xl"
          data-aos="fade-up" // Efek fade-up untuk gambar
          data-aos-duration="1000" // Durasi animasi gambar
        />
        ...
        <div className="relative text-center flex justify-center items-center md:-mt-52 sm:-mt-28 -mt-28">
          ...
          <h1
            ...
            data-aos="fade-up" // Efek fade-up untuk teks dengan border
            data-aos-duration="1200" // Durasi animasi teks dengan border
            data-aos-delay="100" // Delay untuk teks dengan border (100ms setelah gambar)
          >
            Hasan Ahmad Halibah
          </h1>
          ...
          <div
            ...
            data-aos="fade-up" // Efek fade-up untuk teks utama
            data-aos-duration="1200" // Durasi animasi teks utama
            data-aos-delay="200" // Delay untuk teks utama (200ms setelah teks dengan border)
          >
        ...
        <h1
          ...
          data-aos="fade-up" // Efek fade-up untuk subteks
          data-aos-duration="1200" // Durasi animasi subteks
          data-aos-delay="300" // Delay untuk subteks (300ms setelah teks utama)
        >
          WEB DEVELOPER
        </h1>
      </div>
    ...
    >
      <div className="flex flex-wrap md:flex-nowrap items-center">
        ...
        <div
          ...
          data-aos="fade-right" // Efek fade-right untuk gambar
          data-aos-duration="1000" // Durasi animasi gambar
          data-aos-delay="100" // Delay untuk gambar (100ms)
        >
        ...
        <div
          ...
          data-aos="fade-left" // Efek fade-left untuk teks
          data-aos-duration="1000" // Durasi animasi teks
          data-aos-delay="300" // Delay untuk teks (300ms)
        >
          ...
          <button
            className="mt-6 px-6 py-3 bg-[#e9e9ea] text-gray-800 font-semibold rounded-lg hover:bg-gray-300 transition"
            data-aos="fade-left" // Efek fade-left untuk tombol
            data-aos-duration="1000" // Durasi animasi tombol
            data-aos-delay="500" // Delay untuk tombol (500ms)
          >
            Contact Me
          </button>
        </div>
  ...
  <div className="grid md:grid-cols-2 grid-cols-1">
    <div className="flex flex-col">
      <h1 className="text-xl mt-10 font-bold" data-aos="fade-up" data-aos-delay="500">Skills</h1>
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-5 md:pe-5 text-center">
        ...
        <div className="bg-white shadow-md rounded-lg py-3 flex flex-col items-center text-black" data-aos="fade-up" data-aos-delay="1100">
          <SiTailwindcss className="text-teal-400 text-4xl" />
          <h2 className="text-xl font-semibold">Tailwind CSS</h2>
        </div>

        <div className="bg-white shadow-md rounded-lg py-3 flex flex-col items-center text-black" data-aos="fade-up" data-aos-delay="1200">
          <SiLaravel className="text-red-600 text-4xl" />
          <h2 className="text-xl font-semibold">Laravel</h2>
        </div>

        <div className="bg-white shadow-md rounded-lg py-3 flex flex-col items-center text-black" data-aos="fade-up" data-aos-delay="1300">
          <FaReact className="text-cyan-500 text-4xl" />
          <h2 className="text-xl font-semibold">React</h2>
        </div>

        <div className="bg-white shadow-md rounded-lg py-3 flex flex-col items-center text-black" data-aos="fade-up" data-aos-delay="1400">
    ...
    <div className="flex flex-col">
      <h1 className="text-xl font-bold mt-10 text-start" data-aos="fade-up" data-aos-delay="1500">Certificate</h1>
      <div className="flex md:flex-row flex-col md:space-x-3 space-y-5 mt-5">
        <div className="bg-white shadow-lg rounded-lg md:h-56" data-aos="fade-up" data-aos-delay="1600">
          <img
        ...
        <div className="bg-white shadow-lg rounded-lg md:h-56" data-aos="fade-up" data-aos-delay="1700">
          <img
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="grid grid-cols-1 gap-6 mt-3">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center">
          <div className="relative sm:w-1/2 w-[450px] h-full" data-aos="fade-up" data-aos-delay="500">
            <img
              src={JalanSiagaImage}
              alt="Project 1"
          ...
          <div className="p-4 flex flex-col justify-center sm:w-1/2" data-aos="fade-left" data-aos-delay="600">
            ...
            <a href="YOUR_PROJECT_LINK" className='sm:justify-center md:justify-start justify-center mt-10 text-white flex items-center'>
        ...
        {/* Project 2 */}
        <div className="flex flex-col sm:flex-row justify-center items-center">
          <div className="relative sm:w-1/2 w-[450px] h-full" data-aos="fade-up" data-aos-delay="700">
            <img
              src={StoreImage}
              alt="Project 2"
              className="w-full h-full object-cover rounded-xl"
          ...
          <div className="p-4 flex flex-col justify-center sm:w-1/2" data-aos="fade-right" data-aos-delay="800">
        ...
        {/* Project 3 */}
        <div className="flex flex-col sm:flex-row justify-center items-center">
          <div className="relative sm:w-1/2 w-[450px] h-full" data-aos="fade-up" data-aos-delay="900">
            <img
              src={ImageProject}
              alt="Project 3"
              className="w-full h-full object-cover rounded-xl"
          ...
          <div className="p-4 flex flex-col justify-center sm:w-1/2" data-aos="fade-left" data-aos-delay="1000">
      ...
      <div className="pt-8 text-center">
        <button className="px-6 py-2 bg-white text-slate-800 rounded-lg shadow-md transition duration-300" data-aos="fade-up" data-aos-delay="1200">
          View More Projects
        </button>
      </div>
    </div>
